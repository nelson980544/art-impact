...
<link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' fill='%230A0E13'/><text x='16' y='23' font-size='19' font-family='Georgia,serif' fill='%23C9A227' text-anchor='middle'>A</text></svg>">
